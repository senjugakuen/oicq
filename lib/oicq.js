...
const { timestamp, BUF0, BUF16, NOOP } = require("./common");
...
function kickoffListener(data) {
    ...
    } else if (data.info.includes("冻结") || data.info.includes("资金管理") || data.info.includes("下线通知")) {
        sub_type = "frozen";
        this.terminate();
...
Reflect.setPrototypeOf(listeners, null);
